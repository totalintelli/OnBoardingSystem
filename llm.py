...
def build_prompt(query: str, contexts: list[dict]) -> str:
    ...
    return (
        "다음은 사내 규정 문서의 일부입니다. 이 내용을 근거로 한국어로만 답하세요.\n"
        "문서에 적힌 수치와 조건은 그대로 옮기고, 문서에 없는 값을 계산하거나 지어내지 마세요.\n"
        "질문의 표현이 문서의 제목과 정확히 일치하지 않더라도, 내용이 질문에 해당하면 그 내용을 안내하세요.\n"
        "여러 조각이 주어지면 그 중 질문과 가장 직접 관련된 조각 하나를 골라 답하고,"
